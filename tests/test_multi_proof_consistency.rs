...
fn test_masked_matrix_consistency_and_uniqueness() {
    ...
    let ppe_a = gs.groth16_verify_as_ppe_2var(&vk, &x_a);
    ...
    let lhs_a1 = masked_verifier_matrix_canonical_2x2(
        &ppe_a,
        &crs,
        &cpr_a1.xcoms.coms,
        &cpr_a1.ycoms.coms,
    ...
    let lhs_a2 = masked_verifier_matrix_canonical_2x2(
        &ppe_a,
        &crs,
        &cpr_a2.xcoms.coms,
        &cpr_a2.ycoms.coms,
    ...
    let comt_a2 = masked_verifier_comt_2x2(
        &ppe_a,
        &crs,
        &cpr_a2.xcoms.coms,
        &cpr_a2.ycoms.coms,
    ...
    let ppe_b = gs.groth16_verify_as_ppe_2var(&vk, &x_b);
    ...
    let lhs_b = masked_verifier_matrix_canonical_2x2(
        &ppe_b,
        &crs,
        &cpr_b.xcoms.coms,
        &cpr_b.ycoms.coms,
    ...
    let comt_b = masked_verifier_comt_2x2(
        &ppe_b,
        &crs,
        &cpr_b.xcoms.coms,
        &cpr_b.ycoms.coms,
